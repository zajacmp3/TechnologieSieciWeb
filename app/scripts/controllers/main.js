...
var app = angular.module('tswApp').controller('MainCtrl', function($scope) {
	...
	$scope.services = [{'name' : 'Msza św.', 'dayName' : 'Niedziela', 'hour' : '11:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Niedziela', 'hour' : '12:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Niedziela', 'hour' : '16:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Niedziela', 'hour' : '18:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Niedziela', 'hour' : '19:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Niedziela', 'hour' : '21:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Poniedziałek-Sobota', 'hour' : '06:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Poniedziałek-Sobota', 'hour' : '11:00'},
	                   {'name' : 'Msza św.', 'dayName' : 'Poniedziałek-Sobota', 'hour' : '18:00'},
	                  ];
